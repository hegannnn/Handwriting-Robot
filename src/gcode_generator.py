...
def strokes_to_gcode(
    ...
    Both axes are flipped using the stroke bounding box so the drawing
    fills the usable area correctly.
    """
    ...
    def ty(y):
        """Flip Y so software-down becomes machine-up (origin at bottom)."""
